...
class BlogPostSearchMapperTest {
    private final BlogPostSearchMapper blogPostSearchMapper = new BlogPostSearchMapper();
    ...
    class TestToSearchResult {
        ...
        void testToSearchResult_haveResultCase() {
            ...
            var result = blogPostSearchMapper.toSearchResult(searchHits);
    ...
    void toBlogPostSearchResultDto() {
        BlogPostDocument testingBlogPostDocument = BlogPostDocument.builder()
                ...
                .build();
        var result = blogPostSearchMapper.toBlogPostSearchResultDto(testingBlogPostDocument);
        Assertions.assertNotNull(result);
    ...
    void toBlogPostSearchResultDto_null() {
        var result = blogPostSearchMapper.toBlogPostSearchResultDto(null);
